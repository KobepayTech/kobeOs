...
// NOTE: this module previously shipped hardcoded rooms, guests, staff, stock,
// menu items and revenue series (Sarah Johnson, Michael Chen, ...). They are
// intentionally empty: every board below already loads the owner's real records
// from /hotel/*, and inventing occupancy or revenue is never acceptable.
const ROOMS: Room[] = [];
...
const REVENUE_PIE: Array<{ name: string; value: number }> = [];
...
const EXPENSE_DATA: Array<{ category: string; amount: number }> = [];
