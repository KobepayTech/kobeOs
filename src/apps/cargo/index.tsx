...
export default function KOBECARGO() {
  ...
  // Seed shipments + flights into SQLite on first mount so offline users
  // have data. api() POSTs queue automatically when offline.
...
function PayWorkflowTab() {
  const demo = toSharedShipment(shipments[0]);
  return (
    <div className="h-full overflow-auto">
