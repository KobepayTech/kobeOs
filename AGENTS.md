...
- **Electron security:** the active Electron windows use `contextIsolation: true` and `nodeIntegration: false`; renderer access must go through the validated preload bridge. Never expose user input directly to shell commands.
