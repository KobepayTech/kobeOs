...
export class PropertyExtraController {
  ...
  @Post('leases') createLease(@CurrentUser('id') uid: string, @Body() dto: CreateLeaseDto) { return this.leases.create(uid, dto); }
  @Patch('leases/:id') updateLease(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateLeaseDto) { return this.leases.update(uid, id, dto); }
  ...
  @Post('rent-charges') createCharge(@CurrentUser('id') uid: string, @Body() dto: CreateChargeDto) { return this.charges.create(uid, dto); }
  ...
  @Patch('rent-charges/:id') updateCharge(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateChargeDto) { return this.charges.update(uid, id, dto); }
  ...
  @Post('vendors') createVendor(@CurrentUser('id') uid: string, @Body() dto: CreateVendorDto) { return this.vendors.create(uid, dto); }
  @Patch('vendors/:id') updateVendor(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateVendorDto) { return this.vendors.update(uid, id, dto); }
  ...
  @Post('work-orders') createWorkOrder(@CurrentUser('id') uid: string, @Body() dto: CreateWorkOrderDto) { return this.workOrders.create(uid, dto); }
  @Patch('work-orders/:id') updateWorkOrder(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateWorkOrderDto) { return this.workOrders.update(uid, id, dto); }
  ...
  @Post('applications') createApplication(@CurrentUser('id') uid: string, @Body() dto: CreateApplicationDto) { return this.applications.create(uid, dto); }
  @Patch('applications/:id') updateApplication(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateApplicationDto) { return this.applications.update(uid, id, dto); }
  ...
  async approveApplication(@CurrentUser('id') uid: string, @Param('id') id: string) {
    ...
    const updatedApplication = await this.applications.update(uid, id, { status: 'approved' });
  ...
  @Post('expenses') createExpense(@CurrentUser('id') uid: string, @Body() dto: CreateExpenseDto) { return this.expenses.create(uid, dto); }
  @Patch('expenses/:id') updateExpense(@CurrentUser('id') uid: string, @Param('id') id: string, @Body() dto: UpdateExpenseDto) { return this.expenses.update(uid, id, dto); }
