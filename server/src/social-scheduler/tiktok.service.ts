...
export class TikTokService {
  ...
  private safe(account: SocialAccount) {
    ...
    return {
      ...
      openId: account.metadata?.openId ? String(account.metadata.openId) : null,
      unionId: account.metadata?.unionId ? String(account.metadata.unionId) : null,
      profileUrl: account.metadata?.profileDeepLink ? String(account.metadata.profileDeepLink) : null,
      bio: account.metadata?.bio ? String(account.metadata.bio) : null,
      verified: account.metadata?.verified === true,
      status: account.status,
      tokenExpiresAt: account.tokenExpiresAt,
      refreshExpiresAt: account.metadata?.refreshExpiresAt ? String(account.metadata.refreshExpiresAt) : null,
      scopes,
