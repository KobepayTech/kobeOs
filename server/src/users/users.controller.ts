...
export class UsersController {
  ...
  @Get('me')
  me(@CurrentUser('id') id: string) { return this.users.getProfile(id); }

  @Patch('me')
  update(@CurrentUser('id') id: string, @Body() dto: UpdateUserDto) { return this.users.update(id, dto); }
  ...
  @Get(':id')
  @Roles('admin')
  findOne(@Param('id') id: string) { return this.users.getProfile(id); }
